"""
Django settings for event_face project.
...
API_JWT = env("API_JWT")
EVENT_PROVIDER_API_URL = env("EVENT_PROVIDER_API_URL")
NOTIFICATIONS_API_URL = env("NOTIFICATIONS_API_URL")
